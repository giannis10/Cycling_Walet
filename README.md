...
- **Widget Αρχικής Οθόνης:** Δες τις λήξεις των εγγράφων σου απευθείας από την αρχική οθόνη του κινητού σου χωρίς να ανοίξεις την εφαρμογή!
- **Προσαρμόσιμη Εμφάνιση:** Επίλεξε ποια δεδομένα θέλεις να βλέπεις (όλα τα δεδομένα, μόνο την ημερομηνία λήξης, ή μόνο τις μέρες που απομένουν).
- **Έξυπνες Ενδείξεις:** Χρωματιστές τελείες για εύκολη αναγνώριση της κάθε κάρτας (Κόκκινη για UCI, Πράσινη για ΕΟΠ, Μπλε για Υγείας).
- **Άμεση Ενημέρωση:** Χρωματιστό ταμπελάκι (πράσινο αν έχεις πάνω από 30 μέρες, κόκκινο αν πλησιάζει η λήξη ή έχει λήξει).
- **Γρήγορη Πρόσβαση:** Πάτα πάνω στο Widget για να ανοίξει κατευθείαν η εφαρμογή.
